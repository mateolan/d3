d3 = function() {
  ...
  function d3_geo_clip(pointVisible, clipLine, interpolate, clipPoint, sort) {
  ...
  var d3_geo_clipAntimeridian = d3_geo_clip(d3_geo_clipAntimeridianVisible, d3_geo_clipAntimeridianLine, d3_geo_clipAntimeridianInterpolate, [ -π, 0 ], d3_geo_clipAntimeridianSort);
  ...
  function d3_geo_clipCircle(radius) {
    ...
    return d3_geo_clip(visible, clipLine, interpolate, [ radius, 0 ], d3_geo_clipAntimeridianSort);
